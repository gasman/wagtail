...
class TestSitemapGenerator(TestCase):
    ...
    def test_items(self):
        ...
        self.assertIn(self.child_page.basepage_ptr.specific, pages)
        self.assertNotIn(self.unpublished_child_page.basepage_ptr.specific, pages)
        self.assertNotIn(self.protected_child_page.basepage_ptr.specific, pages)
    ...
    def test_non_default_site(self):
        ...
        self.assertIn(self.other_site_homepage.basepage_ptr.specific, pages)
        self.assertNotIn(self.child_page.basepage_ptr.specific, pages)
