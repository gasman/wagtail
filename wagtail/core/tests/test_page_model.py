...
class TestCopyForTranslation(TestCase):
    ...
    def test_copy_homepage(self):
        ...
        self.assertEqual(log_action_registry.format_message(log_entry), "Copied for translation from Root (English)")
    ...
    def test_copy_childpage(self):
        ...
        self.assertEqual(log_entry.data['source_locale']['language_code'], 'en')
        self.assertEqual(log_entry.data['page']['locale']['language_code'], 'fr')
        self.assertEqual(log_action_registry.format_message(log_entry), "Copied for translation from Welcome to the Wagtail test site! (English)")
