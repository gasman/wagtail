...
class TestEditOnlyPermissions(TestCase, WagtailTestUtils):
    def setUp(self):
        ...
        document_changers.permissions.add(
            Permission.objects.get(content_type__app_label='wagtailadmin', codename='access_admin')
        )
        GroupCollectionPermission.objects.create(
            group=document_changers, collection=Collection.get_first_root_node(),
            permission=Permission.objects.get(content_type__app_label='wagtaildocs', codename='change_document')
        )
